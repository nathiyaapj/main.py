...
mydb=mysql.connector.connect(
    user='root',
    host='localhost',
    password='Sairam123',auth_plugin='mysql_native_password')

mycursor=mydb.cursor()
mycursor.execute('CREATE DATABASE if not exists biscard')
mycursor.execute('Use biscard')
...
if selected == "Contact":
    ...
    social_media = {
      "linkedin" :"www.linkedin.com/in/nathiya-palanisamy-610805285",
        "GITHUB":"https://github.com/Nathiyaapj",
        }
    ...
    with col3:
        st.text('Nathiya p')
    with col2:
        st.title('BisCardX: Extracting Business Card Data with OCR')
        st.write(
